...
`git remote add origin https://github.com/LevPermakov/Remote.git` , где origin - имя-псевдоним удаленного репозитория (можно задать любое другое имя).
Убедиться, что связь установлена: `git remote -v`
для получения и отправки изменений:  

origin  https://github.com/LevPermakov/Remote.git (fetch)
origin  https://github.com/LevPermakov/Remote.git (push)
...
6. Отправляем измененя в локальном репозитории в удаленный репозиторий:


## 8.2. Работа с удаленным репозиторием

Информация на GitHub



На локальном ПК создаем папку для клонирования внешнего репозитория.
